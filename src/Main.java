...
public class Main {
    ...
    public static void main(String[] args) {
        Teacher t1 = new Teacher("ŞAKİR","5055255454","TRH");
        Teacher t2 = new Teacher("MURTAZA","5055254323","FZK");
        Teacher t3 = new Teacher("SELAMİ","5055255350","KMY");
        ...
        Student student1 = new Student("İnek Şaban", "1001", "4", tarih, fizik, kimya);
